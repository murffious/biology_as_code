"""
meal_engine.py
Main orchestrator for the reference metabolic simulator (v1.4 — unified).
...
# Core
# ---------------------------------------------------------------------------
from biology_as_code.models.nutrition_ontology import NutritionOntology
...
class MealEngine:
    ...
    def __init__(self):
        log.debug(f"Initializing meal engine {self.VERSION} ...")
        ...
        # Core state
        self.ontology = NutritionOntology()
    ...
    def simulate_payload(
        ...
        *,
        ...
        analysis is installed **and** enable_external_score is True
        (or self.enable_external_score). Open dig path never requires it.
        """
        ...
        report["claim_tiers"] = {
            ...
            "external_score_analysis": "proprietary_optional",
            "notes": (
                "flow = teaching sim numbers; units_provisional = formal walk, "
                "magnitude not locked; external_score_analysis is patent-pending "
        ...
        report["external_score_analysis"] = run_external_score_analysis(
            payload=payload,
            depth_report=report,
        ...
        psa = report["external_score_analysis"]
        if psa.get("available"):
            ...
            log.debug(
                "  External product scoring: skipped "
                "(enable_external_score=False) — open dig + FLOW evals only"
            )
    ...
    def _colon_scfa_units_walk(
        ...
        *,
        ...
        try:
            ...
            from biology_as_code.engine.pathways import (
                COLON_SCFA_PATHWAY,
