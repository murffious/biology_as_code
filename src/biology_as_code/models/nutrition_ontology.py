...
# Auto-load on import
NutritionOntology.load_master()


if __name__ == "__main__":
    print("Total terms:", len(NutritionOntology.all_terms()))
    print("Sample search 'vitamin':", [t.name for t in NutritionOntology.search("vitamin")[:5]])
