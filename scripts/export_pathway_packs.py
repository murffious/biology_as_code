...
Gold extras: pathways/packs/glycolysis/glycolysis_extra/ (hand-authored mermaid).
Auto packs: src/biology_as_code/pathways/packs/<id>/ (next to Python modules).
...
def main() -> None:
    ...
    for pack_id, module, pathway in collect_pathways():
        ...
        print(f"  wrote packs/{pack_id}/  (n={n} e={e})")
    ...
    lines = [
        ...
        "",
        f"Gold extras: [`glycolysis/glycolysis_extra/`](./glycolysis/glycolysis_extra/) (exists={GOLD.is_dir()})",
        "",
